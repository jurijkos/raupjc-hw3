...
namespace Task2
{
    public interface ITodoRepository
    {
        ...
        /// with appropriate message if user is not the owner of Todo item
        /// </summary>
        ...
        /// TodoAccessDeniedException with appropriate message if user is not the
        ...
        /// Throw  TodoAccessDeniedException with appropriate message if user is not the
        /// owner of the Todo item
        /// </summary>
